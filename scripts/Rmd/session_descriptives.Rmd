...
# Session-Level Clean, Filter and Produce Descriptive Graphs
...
df <- select(df, "ACADEMIC_YEAR", "SESSION_ID", "STUDENT_ID", "TUTOR_ID", "SESSION_DATE", "STUDY_DATE",
                 ...
                 "STUDENT_WINTER_MAP_2324", "TUTOR_IS_FEMALE", "TUTOR_QA_SCORE", "TUTOR_AGE",
                 "TUTOR_USER_NAME", "ACTUAL_SESSION_DURATION")
...
### Sample Breakdown School x Grade 
```{r}
...
#### Number of Clicks, Exclude 0 (F6b)
```{r}
